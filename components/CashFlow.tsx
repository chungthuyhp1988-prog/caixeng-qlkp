...
import { ArrowUpRight, ArrowDownRight, Wallet, Calendar, Search, Wrench, Users, Box, PlusCircle, X } from 'lucide-react';
...
const CashFlow: React.FC<CashFlowProps> = ({ transactions, onAddTransaction }) => {
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-slate-800 rounded-2xl border border-slate-700 p-6 w-full max-w-md shadow-2xl animate-in fade-in duration-200">
            <div className="flex justify-between items-center mb-6">
               <h3 className="text-xl font-bold text-white">Tạo Khoản Chi Mới</h3>
